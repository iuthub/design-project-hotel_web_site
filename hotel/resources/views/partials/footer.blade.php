...
<footer class="page-footer font-small stylish-color-dark pt-4">
          ...
          <!-- Grid row -->
            <div class="row">
                ...
                <div class="col-md-6 mx-auto">
                    <!-- Content -->
                    <h5 class="font-weight-bold text-uppercase mt-3 mb-4">Uzbekapolis</h5>
                ...
                <div class="col-md-6 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    ...
                    <p>
                        <i class="fas fa-home mr-3"></i>1 A Navoi St, Ташкент 100017, Узбекистан
                    </p>
                    <p>
                        <i class="fas fa-envelope mr-3"></i> info@example.com
                    </p>
                    <p>
                        <i class="fas fa-phone mr-3"></i>+99897–772–64–62
                    </p>
                    <p>
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center py-3">&copy;All Right Reserved 
          <a href="/"> Uzbekapolis.com</a>
        </div>
        <!-- Copyright -->
