      ...
      <div id="demo-2" class="carousel slide karusel" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active view overlay zoom">
            <img width="100%" src="css/img/1.jpg" alt="" width="650" height="490">
          </div>
          <div class="carousel-item view overlay zoom">
            <img width="100%" src="css/img/2.jpg" alt="" width="650" height="490">
          </div>
          <div class="carousel-item view overlay zoom">
            <img width="100%" src="css/img/p3.jpg" alt="" width="650" height="490">
          </div>
        </div>
  ...
  <div class="single row flex-lg-row-reverse">
    ...
    <div class="col-lg-6">
      <div id="demo-3" class="carousel slide karusel" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active view overlay zoom">
            <img width="100%" src="css/img/room-2.jpg" alt="" width="650" height="490">
          </div>
          <div class="carousel-item view overlay zoom">
            <img width="100%" src="css/img/room-3.jpg" alt="" width="650" height="490">
          </div>
          <div class="carousel-item view overlay zoom">
            <img width="100%" src="css/img/room-5.jpg" alt="" width="650" height="490">
          </div>
        </div>
  ...
  <div class="single row">
    ...
    <div class="col-lg-6">
      <div id="demo" class="carousel slide karusel" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active view overlay zoom">
            <img width="100%" src="css/img/4.jpg" alt="" width="650" height="490">
          </div>
          <div class="carousel-item view overlay zoom">
            <img width="100%" src="css/img/5.jpg" alt="" width="650" height="490">
          </div>
          <div class="carousel-item view overlay zoom">
            <img width="100%" src="css/img/6.jpg" alt="" width="650" height="490">
          </div>
        </div>
