...
<head>
  ...
  <!-- Bootstrap tooltips -->
  <script type="text/javascript" src="http://localhost:8000/js/popper.min.js"></script>
  <!-- Bootstrap core JavaScript -->
  <script type="text/javascript" src="http://localhost:8000/js/bootstrap.min.js"></script>
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="http://localhost:8000/js/mdb.min.js"></script>
    <!-- Fonts -->
  ...
  <link href="http://localhost:8000/css/mdb.min.css" rel="stylesheet">
